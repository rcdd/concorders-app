...
/***/ "./node_modules/raw-loader/index.js!./src/app/components/product-item/product-item.component.html":
/*!***********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/components/product-item/product-item.component.html ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<ion-item lines=\"full\" [class.isSelected]=\"item.amount > 0\">\n    <ion-badge slot=\"start\" color=\"light\">{{item.amount || 0}}</ion-badge>\n    <ion-label>{{item.name}}</ion-label>\n    <ion-buttons slot=\"end\">\n        <ion-icon class=\"ion-padding\" name=\"add-circle-outline\" size=\"large\" (click)=\"addProduct()\"></ion-icon>\n        <ion-icon class=\"ion-padding\" name=\"remove-circle-outline\" size=\"large\" (click)=\"removeProduct()\"></ion-icon>\n    </ion-buttons>\n</ion-item>\n"
...
/* harmony import */ var _product_item_product_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./product-item/product-item.component */ "./src/app/components/product-item/product-item.component.ts");
...
module.exports = "ion-item.isSelected {\n  --ion-background-color: rgba(255, 233, 41, 0.6);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProductItemComponent = /** @class */ (function () {
    function ProductItemComponent(utils) {
        this.utils = utils;
    }
    ...
    ProductItemComponent.prototype.getItem = function () {
        var _this = this;
        return this.utils.currentOrder.request.find(function (item) { return item.name === _this.item.name; });
    };
    ProductItemComponent.prototype.addProduct = function () {
    ...
    ProductItemComponent.prototype.removeProduct = function () {
        var _this = this;
        ...
        this.item.amount--;
        if (this.item.amount === 0) {
            var index = this.utils.currentOrder.request.findIndex(function (it) { return it.id === _this.item.id; });
            if (index > -1) {
    ...
    ProductItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./product-item.component.html */ "./node_modules/raw-loader/index.js!./src/app/components/product-item/product-item.component.html"),
            styles: [__webpack_require__(/*! ./product-item.component.scss */ "./src/app/components/product-item/product-item.component.scss")]
        }),
...
/*!******************************************!*\
  !*** ./src/app/services/rest.service.ts ***!
  \******************************************/
/*! exports provided: SearchType, OrderFillableFields, RequestItemFillableFields, RestService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SearchType", function() { return SearchType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderFillableFields", function() { return OrderFillableFields; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RequestItemFillableFields", function() { return RequestItemFillableFields; });
...
var OrderFillableFields = /** @class */ (function () {
    function OrderFillableFields() {
    }
    return OrderFillableFields;
}());

var RequestItemFillableFields = /** @class */ (function () {
    function RequestItemFillableFields() {
    }
    return RequestItemFillableFields;
}());
...
var RestService = /** @class */ (function () {
     ...
     */
    function RestService(http, storage) {
        this.http = http;
        this.storage = storage;
        this.updateConfig();
    }
    RestService.prototype.updateConfig = function () {
        var _this = this;
        this.storage.get('concorders-config').then(function (val) {
            if (val) {
                var json = JSON.parse(val);
                _this.baseUrl = 'http://' + json.ip + ':' + json.port + '/api';
            }
        });
    };
    ...
    RestService.prototype.getPlaces = function (tableId) {
        return this.http.get(this.baseUrl + '/get-places/' + tableId);
    };
    RestService.prototype.getMenus = function () {
        return this.http.get(this.baseUrl + '/get-menus');
    };
    RestService.prototype.getActiveOrder = function (placeId) {
        return this.http.get(this.baseUrl + '/get-order/' + placeId);
    };
    RestService.prototype.newOrder = function (placeId, order) {
        return this.http.post(this.baseUrl + '/new-order', { placeId: placeId, order: order });
    };
    RestService.prototype.updateOrder = function (orderId, requests) {
        return this.http.post(this.baseUrl + '/update-order', { orderId: orderId, requests: requests });
    };
...
var UtilsService = /** @class */ (function () {
    ...
    UtilsService.prototype.showLoading = function (text) {
