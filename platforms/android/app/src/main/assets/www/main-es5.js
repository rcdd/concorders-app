...
var routes = [
    ...
    { path: 'order', loadChildren: function () { return Promise.all(/*! import() | pages-order-order-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-order-order-module")]).then(__webpack_require__.bind(null, /*! ./pages/order/order.module */ "./src/app/pages/order/order.module.ts")).then(function (m) { return m.OrderPageModule; }); } },
    {
        path: 'table-selection',
        loadChildren: function () { return Promise.all(/*! import() | pages-table-selection-table-selection-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-table-selection-table-selection-module")]).then(__webpack_require__.bind(null, /*! ./pages/table-selection/table-selection.module */ "./src/app/pages/table-selection/table-selection.module.ts")).then(function (m) { return m.TableSelectionPageModule; }); }
    },
    { path: 'config', loadChildren: function () { return Promise.all(/*! import() | pages-config-config-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-config-config-module")]).then(__webpack_require__.bind(null, /*! ./pages/config/config.module */ "./src/app/pages/config/config.module.ts")).then(function (m) { return m.ConfigPageModule; }); } },
];
...
/* harmony import */ var _ionic_core_dist_collection_utils_transition_ios_transition_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic/core/dist/collection/utils/transition/ios.transition.js */ "./node_modules/@ionic/core/dist/collection/utils/transition/ios.transition.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot({
                    navAnimation: _ionic_core_dist_collection_utils_transition_ios_transition_js__WEBPACK_IMPORTED_MODULE_11__["iosTransitionAnimation"],
                }), _ionic_storage__WEBPACK_IMPORTED_MODULE_10__["IonicStorageModule"].forRoot(),
                _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"]
            ],
            providers: [
...
module.exports = __webpack_require__(/*! /Users/rubendomingues/Documents/ConcOrders/src/main.ts */"./src/main.ts");
