...
let StartersPageModule = class StartersPageModule {
};
...
let StartersPage = class StartersPage {
    constructor(utils) {
        this.utils = utils;
        this.menu = [];
    }
...
//# sourceMappingURL=tabs-starters-starters-module-es2015.js.map